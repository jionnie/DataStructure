...
public class MyStack<E> {
	...
	public MyStack() {
		...
		this.top = -1; // 기본 빈 값을 표현하기 위해 -1로 초기화
	}
	...
	// ArrayList에서 알아서 리사이징 되니 구현할 필요 x
	// private void resize() {}
	...
	public int search(E value) {
		// 스택은 같은 요소값이 있으면 가장 마지막에 추가한 요소를 먼저 반환하기 때문에 lastIndexOf() 메소드를 사용
	...
	public String toString() {
		return list.toString(); // ArrayList의 toString() 메소드만 호출 하면 됨
	}
}
